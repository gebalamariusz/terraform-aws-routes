# Contributing to AWS Routes Terraform Module
...
Examples:
```
feat(routes): add support for core network ARN
fix(validation): correct target count logic
...
- Prefix resources with module name: `aws_route.this`
- Use descriptive variable names

#### Structure

```
terraform-aws-routes/
